...
function LoginInner() {
  ...
  const externalError =
    authError === "Configuration" ? "Configuração de login inválida. Contate o suporte."
    : authError === "OAuthCallback" ? "Falha no retorno do Google. Tente novamente."
    : authError === "AccessDenied" ? "Acesso negado."
    : authError ? `Erro de autenticação: ${authError}`
    : null
