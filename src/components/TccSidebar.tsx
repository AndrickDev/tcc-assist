                        ...
                        <div className="flex items-center justify-between p-3 bg-[var(--brand-surface)] border border-[var(--brand-border)] rounded-xl hover:bg-[var(--brand-surface)] transition-colors">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <div className="text-[10px] text-[var(--brand-accent)]/70 font-bold mt-1 uppercase tracking-wider">Estimativa (Mock)</div>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <div className={cn(
                                    "w-2 h-2 rounded-full animate-pulse",
                                    turnitin <= 10 ? "bg-green-500" : turnitin <= 25 ? "bg-[var(--brand-accent)]" : "bg-red-500"
                                )} />
                                <span className={cn(
                                    "text-sm font-bold",
                                    turnitin <= 10 ? "text-green-500" : turnitin <= 25 ? "text-[var(--brand-accent)]" : "text-red-500"
                                )}>{turnitin}%</span>
                            </div>
                        </div>
