...
export function HeroVideo({
  ...
  // Prepared for mp4/webm. If `src` is not provided, render a refined placeholder.
  if (!src) {
    return (
      <div
        className={cn(
      ...
      >
        <div className="absolute inset-0 opacity-35" style={{ background: "radial-gradient(circle at 30% 20%, rgba(250,249,245,0.15), transparent 55%)" }} />
        <div className="absolute inset-0 opacity-18" style={{ background: "radial-gradient(circle at 70% 70%, rgba(255,255,255,0.10), transparent 55%)" }} />
        ...
        <div className="relative h-full w-full flex items-end p-6">
          <div className="text-sm text-white/80">
            Video do produto (vertical) entra aqui.
